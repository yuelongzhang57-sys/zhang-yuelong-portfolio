...
import "./official-dome-gallery.css";
...
function DomeGallery({
  ...
  return (
    <div
      ref={rootRef}
      className="sphere-root official-dome-gallery"
      style={{
        ["--segments-x"]: segments,
        ["--segments-y"]: segments,
...
export function mountOfficialDomeGallery(target, props) {
  if (!target) return null;
  const root = createRoot(target);
  root.render(<DomeGallery {...props} />);
  return root;
}
